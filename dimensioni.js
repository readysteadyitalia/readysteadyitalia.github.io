  ...
  if(x10 <= x9) {
    if(x8 <= x7) {
      $("#ver6").css({
        ...
        left: x7+x9+2*m+"px", bottom: "0",

      })
    } else {
      $("#ver6").css({
        width: x6+"px", height: x6+"px",
        left: x8+x9+2*m+"px", bottom: "0",
    ...
    if(x8 <= x7) {
      $("#ver6").css({
        width: x6+"px", height: x6+"px",
        left: x7+x10+2*m+"px", bottom: "0",

      })
    } else {
      $("#ver6").css({
        width: x6+"px", height: x6+"px",
        left: x8+x10+2*m+"px", bottom: "0",
    ...
    if(x8 <= x7) {
      $("#ver6").css({
        width: x6+"px", height: x6+"px",
        right: x7+x9+m*2+"px", bottom: "0",

      })
    } else {
      $("#ver6").css({
        width: x6+"px", height: x6+"px",
        right: x8+x9+m*2+"px", bottom: "0",
  ...
  if (x9 <= x7) {
    ...
    if(x15 <= x14) {
      if(x13 <= x12) {
        $("#ver11").css({
          ...
          left: x12+x14+2*m+"px", top: "0",

        })
      } else {
        $("#ver11").css({
          width: x11+"px", height: x11+"px",
          left: x13+x14+2*m+"px", top: "0",
      ...
      if(x13 <= x12) {
        $("#ver11").css({
          width: x11+"px", height: x11+"px",
          left: x12+x15+2*m+"px", top: "0",

        })
      } else {
        $("#ver11").css({
          width: x11+"px", height: x11+"px",
          left: x13+x15+2*m+"px", top: "0",
      ...
      if(x13 <= x12) {
        $("#ver11").css({
          width: x11+"px", height: x11+"px",
          right: x12+x14+m*2+"px", bottom: "0",

        })
      } else {
        $("#ver11").css({
          width: x11+"px", height: x11+"px",
          right: x13+x14+m*2+"px", bottom: "0",
    ...
    if(x20 <= x4) {
      ...
      if(x18 <= x17) {
        $("#ver16").css({
          width: x16+"px", height: x16+"px",
          right: x17+x19+m*2+"px", bottom: "0",

        })
      } else {
        $("#ver16").css({
          width: x16+"px", height: x16+"px",
          right: x18+x19+m*2+"px", bottom: "0",
